...
class MyIndicator extends LeafRenderObjectWidget {
  const MyIndicator({
    super.key,
  ...
  void updateRenderObject(
    ...
    covariant MyIndicatorChart renderObject,
  ) {
...
class MyIndicatorChart extends RenderBox with RenderObjectAnimationMixin {
  double strokeWidth;
  Color color;
  bool outline;
